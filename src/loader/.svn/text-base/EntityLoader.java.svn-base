...
public class EntityLoader
{
    ...
    {
        MaterialContainer container = JAXB.unmarshal(new File(materialFile), MaterialContainer.class);
	...
	{
		DocumentBuilder builder = factory.newDocumentBuilder();
		Document doc = builder.parse(itemFile);
	...
	{
		DocumentBuilder builder = factory.newDocumentBuilder();
		Document doc = builder.parse(creatureFile);
